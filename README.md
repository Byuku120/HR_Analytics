...
Created new columns (e.g., age groups, binary encodings) for analysis.
...
Visualized attrition rates by department, job role, age group, gender, etc.
...
Used Chi-Square test for relationships between categorical variables (e.g., Job Role vs Attrition).
...
Overtime and low job satisfaction are strong indicators of attrition.
...
Markdown explanations for each step of the analysis.
